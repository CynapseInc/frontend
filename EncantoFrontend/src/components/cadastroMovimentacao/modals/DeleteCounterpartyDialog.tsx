...
export default function DeleteCounterpartyDialog({ isOpen, onClose, onConfirm, counterpartyName }: DeleteCounterpartyDialogProps) {
  return (
      ...
      >
        <div className="p-8">
          <AlertDialogTitle className="text-[24px] mb-3" style={{ color: '#6D6875' }}>
            Deseja realmente excluir esta contraparte?
          </AlertDialogTitle>
          <AlertDialogDescription className="text-[15px] mb-6" style={{ color: '#9D8189' }}>
            A contraparte <span style={{ color: '#F4ACB7' }}>{counterpartyName}</span> será removida permanentemente do sistema. Esta ação não pode ser desfeita.
