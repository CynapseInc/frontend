...
export default function CounterpartyCombobox({ value, defaultName = '', onChange, isErr }: CounterpartyComboboxProps) {
  ...
  const handleSelect = (counterparty: Contraparte) => {
    onChange(String(counterparty.id), counterparty.nome);
    setSelectedName(counterparty.nome);
    setOpen(false);
    setSearch('');
  };
  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      ...
      >
        <span>{selectedName || 'Selecione uma contraparte...'}</span>
