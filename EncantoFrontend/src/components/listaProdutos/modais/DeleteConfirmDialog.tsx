...
export default function DeleteConfirmDialog({ isOpen, onClose, onConfirm, productTitulo }: DeleteConfirmDialogProps) {
  return (
      ...
      >
        <div className="p-8">
          ...
          <AlertDialogDescription className="text-[15px] mb-6" style={{ color: '#9D8189' }}>
            O produto <span style={{ color: '#F4ACB7' }}>{productTitulo}</span> será removido permanentemente do sistema. Esta ação não pode ser desfeita.
