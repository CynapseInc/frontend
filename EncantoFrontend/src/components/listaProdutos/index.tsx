  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F9F9F9' }}>
      <div className="w-full max-w-[1600px] mx-auto px-8 py-10 box-border">
        ...
        <div className="mb-10">
          <h1 className="text-[48px] mb-2 titulo-produtos" style={{ color: '#F4ACB7' }}>Produtos</h1>
        ...
        <div className="bg-white rounded-lg p-6 mb-6 shadow-sm" style={{ border: '1px solid #D8E2DC' }}>
          ...
          <div className="flex items-center gap-4 filtros-container">
          ...
          <table className="w-full min-w-[1000px]">
            <thead>
              <tr style={{ backgroundColor: '#FFE5D9', borderBottom: '1px solid #D8E2DC' }}>
                <th className="text-left px-6 py-4 text-[16px] whitespace-nowrap" style={{ color: '#6D6875', width: '10%' }}>Foto</th>
                <th className="text-left px-6 py-4 text-[16px] whitespace-nowrap min-w-[250px]" style={{ color: '#6D6875', width: '30%' }}>Nome do Produto</th>
                <th className="text-left px-6 py-4 text-[16px] whitespace-nowrap" style={{ color: '#6D6875', width: '15%' }}>Categoria</th>
                <th className="text-left px-6 py-4 text-[16px] whitespace-nowrap" style={{ color: '#6D6875', width: '15%' }}>Tema</th>
                <th className="text-center px-5 py-4 text-[16px] whitespace-nowrap" style={{ color: '#6D6875', width: '20%' }}>Item</th>
                <th className="text-right px-5 py-4 text-[16px] whitespace-nowrap" style={{ color: '#6D6875', width: '10%' }}>Ações</th>
              </tr>
            </thead>
            <tbody>
              {currentProducts.map((product, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-[14px] whitespace-nowrap" style={{ backgroundColor: '#FFCAD4', color: '#6D6875' }}>
                        {product.tema?.categoriaTema?.titulo || 'Sem Categoria'}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-[15px] whitespace-nowrap" style={{ color: '#9D8189' }}>
                        {product.tema?.descricao || 'Sem tema'}
                      </span>
                    </td>
                    <td className="px-5 py-4 text-center">
                      <span
                        className="inline-flex min-h-9 items-center justify-center rounded-md px-3 py-1.5 text-center text-[14px] leading-5 whitespace-nowrap"
                        style={{
