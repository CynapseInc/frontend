...
export default function DeleteConfirmDialog({ isOpen, onClose, onConfirm, employeeName }: DeleteConfirmDialogProps) {
  return (
      ...
      >
        <div className="p-8">
          ...
          <AlertDialogDescription className="text-[15px] mb-6" style={{ color: '#9D8189' }}>
            O funcionário <span style={{ color: '#F4ACB7' }}>{employeeName}</span> será removido permanentemente do sistema. Esta ação não pode ser desfeita.
